...
class Trainer(object):
    ...
    def get_episode(self, epoch):
        if self.policy_net.name == 'gacomm' or self.policy_net.name == 'magic':
            self.policy_net.reset_delay_buffer()  # Reset the delay buffer
        episode = []
        ...
        for t in range(self.args.max_steps):
            ...
            if self.args.recurrent:
                ...
                if self.args.gacomm:
                    ...
                    action_out, value, prev_hid = self.policy_net(x, info) # ------ GET ACTION
            ...
            next_state, reward, done, info = self.env.step(actual)  # ------ TAKE ACTION
    ...
    # for testing - nprocesses=1
    def test_batch(self, epoch):
        
        # test_run_batch()
        batch, stat = self.test_run_batch(epoch)
