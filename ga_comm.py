...
class GACommNetMLP(nn.Module):
    def __init__(self, args, num_inputs):
        ...
        self.args = args
        self.hop_delay_buffer = deque(maxlen=self.args.delay_step) # Buffer to store past comm tensors
    ...
    def forward(self, x, info={}):
        ...
        if not self.args.comm_mask_zero:
            ...
            if self.args.comm_constraints == 'simple' and self.args.noise_level > 0.0:
                ...
                comm = drop_messages(comm, self.args.drop_prob_whole, self.args.drop_prob_part)
            elif self.args.comm_constraints == 'jumble':
                comm = jumble_messages(comm, self.args.jumble_prob)
            elif self.args.comm_constraints == 'delay':
                comm = comm_delay_n_hops(comm, self.hop_delay_buffer,
